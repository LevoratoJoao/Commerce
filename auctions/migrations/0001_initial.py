    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creationDate', models.DateTimeField(auto_now_add=True, null=True)),
                ('listingComment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.auctionlistings')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creationDate', models.DateTimeField(auto_now_add=True, null=True)),
                ('auctionListing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listing', to='auctions.auctionlistings')),
                ('userBid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
